...
public class EnrollmentManagementPanel extends JPanel {
    ...
    private JPanel createForm() {
        ...
        formPanel.add(new JLabel("Actors.Student ID:"));
        ...
        JButton addButton = new JButton("Add Logic.Enrollment");
    ...
    private JScrollPane createTable() {
        ...
        model.setColumnIdentifiers(new String[]{"Actors.Student ID", "Actors.Course ID"});
    ...
    private void addEnrollment(ActionEvent e) {
        ...
        if (student != null && course != null) {
            ...
            JOptionPane.showMessageDialog(this, "Actors.Student ID or Actors.Course ID not found", "Error", JOptionPane.ERROR_MESSAGE);
        }
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (data.length >= 2) {
                        ...
                        if (student != null && course != null) {
                            ...
                            JOptionPane.showMessageDialog(this, "Actors.Student ID " + studentId + " or Actors.Course ID " + courseId + " not found", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
    ...
    private void saveEnrollmentsToFile(ActionEvent e) {
        try (FileWriter writer = new FileWriter("enrollments.csv")) {
            writer.append("Actors.Student ID,Actors.Course ID\n");
