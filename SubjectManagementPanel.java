...
public class SubjectManagementPanel extends JPanel {
    ...
    private JScrollPane createTable() {
        ...
        model.setColumnIdentifiers(new String[]{"ID", "Name", "Course ID"});
    ...
    private void addSubject(ActionEvent e) {
        ...
        if (course != null) {
            Subject subject = new Subject(id, name, course);
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (data.length >= 3) {
                        ...
                        if (course != null) {
                            ...
                            JOptionPane.showMessageDialog(this, "Course ID " + courseId + " not found", "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
    ...
    private void saveSubjectsToFile(ActionEvent e) {
        try (FileWriter writer = new FileWriter("subjects.csv")) {
            writer.append("ID,Name,Course ID\n");
